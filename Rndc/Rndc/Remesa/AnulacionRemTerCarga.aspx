    ...
    <div>
        <asp:Table runat="server">
            <asp:TableRow runat="server">
                ...
                <asp:TableCell runat="server">
                    <asp:DropDownList ID="slt_tipo_reversa" runat="server">
                        <asp:ListItem Value="A" Text="Anular"></asp:ListItem>
                        <asp:ListItem Value="L" Text="Liberar"></asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
